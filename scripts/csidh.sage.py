...
# This file was *autogenerated* from the file csidh.sage
from sage.all_cmdline import *   # import sage library

_sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_100 = Integer(100); _sage_const_5 = Integer(5); _sage_const_4 = Integer(4); _sage_const_7 = Integer(7)
class CSIDH:
    ...
    def get_public(self, private):
        ...
        return self.group_action(_sage_const_0 , private)
    ...
    def group_action(self, A, e):
        ...
        # interval
        E = EllipticCurve(self.Fp, [_sage_const_0 , A, _sage_const_0 , _sage_const_1 , _sage_const_0 ])
        ...
        while any([e_i != _sage_const_0  for e_i in e]):
            x = self.Fp.random_element()
            s = _sage_const_1  if self.Fp(x**_sage_const_3  + A*x**_sage_const_2  + x).is_square() else -_sage_const_1 
            S = [i for i in range(len(e)) if e[i] != _sage_const_0  and sign(e[i]) == s]
            ...
            T = ((self.p + _sage_const_1 ) // k) * P

            for i in S:
                assert k % self.primes[i] == _sage_const_0 
...
if __name__ == '__main__':
    for _ in range(_sage_const_100 ):
        m = _sage_const_5 
        a = [randint(-m, m+_sage_const_1 ) for _ in range(_sage_const_3 )]
        b = [randint(-m, m+_sage_const_1 ) for _ in range(_sage_const_3 )]
        csidh = CSIDH(_sage_const_4  * _sage_const_3  * _sage_const_5  * _sage_const_7  - _sage_const_1 , [_sage_const_3 ,_sage_const_5 ,_sage_const_7 ], _sage_const_5 )
